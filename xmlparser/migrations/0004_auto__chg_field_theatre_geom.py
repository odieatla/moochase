...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'xmlparser_theatre', 'geom', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, spatial_index=False))

    def backwards(self, orm):

        # Changing field 'Theatre.geom'
        db.alter_column(u'xmlparser_theatre', 'geom', self.gf('django.contrib.gis.db.models.fields.PointField')(default=None, spatial_index=False))
    ...
    models = {
        u'xmlparser.theatre': {
            ...
            'geom': ('django.contrib.gis.db.models.fields.PointField', [], {'default': 'None', 'null': 'True', 'spatial_index': 'False', 'blank': 'True'}),
