...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TheatreMovie', fields ['movie_id', 'theatre', 'date', 'time', 'qualifiers']
        db.create_unique(u'xmlparser_theatremovie', ['movie_id', 'theatre_id', 'date', 'time', 'qualifiers'])
        ...
        # Adding index on 'TheatreMovie', fields ['movie_id', 'theatre', 'date', 'time', 'qualifiers']
        db.create_index(u'xmlparser_theatremovie', ['movie_id', 'theatre_id', 'date', 'time', 'qualifiers'])


    def backwards(self, orm):
        # Removing index on 'TheatreMovie', fields ['movie_id', 'theatre', 'date', 'time', 'qualifiers']
        db.delete_index(u'xmlparser_theatremovie', ['movie_id', 'theatre_id', 'date', 'time', 'qualifiers'])
        ...
        # Removing unique constraint on 'TheatreMovie', fields ['movie_id', 'theatre', 'date', 'time', 'qualifiers']
        db.delete_unique(u'xmlparser_theatremovie', ['movie_id', 'theatre_id', 'date', 'time', 'qualifiers'])
    ...
    models = {
        ...
        u'xmlparser.theatremovie': {
            'Meta': {'unique_together': "(('movie_id', 'theatre', 'date', 'time', 'qualifiers'),)", 'object_name': 'TheatreMovie', 'index_together': "[['movie_id', 'theatre', 'date', 'time', 'qualifiers']]"},
