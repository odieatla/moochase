...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.name10'
        db.add_column(u'xmlparser_movie', 'name10',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'Movie.name20'
        db.add_column(u'xmlparser_movie', 'name20',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Movie.name40'
        db.add_column(u'xmlparser_movie', 'name40',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'Movie.name'
        db.add_column(u'xmlparser_movie', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.name10'
        db.delete_column(u'xmlparser_movie', 'name10')

        # Deleting field 'Movie.name20'
        db.delete_column(u'xmlparser_movie', 'name20')

        # Deleting field 'Movie.name40'
        db.delete_column(u'xmlparser_movie', 'name40')

        # Deleting field 'Movie.name'
        db.delete_column(u'xmlparser_movie', 'name')
